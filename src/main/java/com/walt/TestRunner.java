...
public class TestRunner implements CommandLineRunner {
    ...
    private void createRestaurant(City jerusalem, City tlv) {
        ...
        restaurantRepository.saveAll(Arrays.asList(meat, vegan, cafe, chinese, mexican));
    }
    ...
    private void createCustomers(City jerusalem, City tlv, City haifa) {
        ...
        customerRepository.saveAll(Arrays.asList(beethoven, mozart, chopin, rachmaninoff, bach));
    }
    ...
    private void createDrivers(City jerusalem, City tlv, City bash, City haifa) {
        ...
        driverRepository.saveAll(Arrays.asList(mary, patricia, jennifer, james, john, robert, david, daniel, noa, ofri, nata));
    }
}
